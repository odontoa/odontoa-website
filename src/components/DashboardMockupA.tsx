...
// Mockup A: Primary view - Header, KPI cards, Quick actions, Status termina danas, Termini po danima
const DashboardMockupA = () => {
  return (
                ...
                <div className="bg-white rounded-2xl border border-slate-200/60 p-5" style={{
                  ...
                  >
                    ...
                    <div className="flex items-center gap-6">
                      <div className="relative" style={{ width: '207px', height: '207px' }}>
                        <svg width="207" height="207" style={{ transform: 'rotate(-90deg)' }}>
                          {/* Background circle */}
                          <circle cx="103.5" cy="103.5" r="87" fill="#f8fafc"></circle>
                          <circle cx="103.5" cy="103.5" r="87" fill="none" stroke="rgba(15, 23, 42, 0.04)" strokeWidth="1"></circle>
                          
                          {/* Track circle - subtle background ring */}
                          <motion.circle 
                            cx="103.5" 
                            cy="103.5" 
                            r="90" 
                          ...
                          {/* Zakazani (Blue): 10/18 = 55.56% = 314.16px (circumference = 2π×90 = 565.49) */}
                          <motion.circle 
                            cx="103.5" 
                            cy="103.5" 
                            r="90" 
                            ...
                            stroke="#2563eb" 
                            strokeWidth="14" 
                            strokeDasharray="314.16 565.49" 
                            strokeLinecap="round"
                            initial={{ strokeDashoffset: 314.16, opacity: 0 }}
                            whileInView={{ strokeDashoffset: 0, opacity: 1 }}
                            viewport={{ once: true, margin: "-100px" }}
                            transition={{ 
                              strokeDashoffset: { duration: 1.2, delay: 0.3, ease: [0.34, 1.56, 0.64, 1] },
                              opacity: { duration: 0.3, delay: 0.3 }
                            }}
                          />
                          
                          {/* Završeni (Green): 5/18 = 27.78% = 157.08px */}
                          <motion.circle 
                            cx="103.5" 
                            cy="103.5" 
                            r="90" 
                            ...
                            stroke="#22c55e" 
                            strokeWidth="14" 
                            strokeDasharray="157.08 565.49" 
                            strokeLinecap="round"
                            initial={{ strokeDashoffset: 157.08, opacity: 0 }}
                            whileInView={{ strokeDashoffset: -314.16, opacity: 1 }}
                            viewport={{ once: true, margin: "-100px" }}
                            transition={{ 
                              strokeDashoffset: { duration: 0.9, delay: 1.4, ease: [0.34, 1.56, 0.64, 1] },
                              opacity: { duration: 0.3, delay: 1.4 }
                            }}
                          />
                          
                          {/* Otkazani (Red): 3/18 = 16.67% = 94.25px */}
                          <motion.circle 
                            cx="103.5" 
                            cy="103.5" 
                            r="90" 
                            ...
                            stroke="#ef4444" 
                            strokeWidth="14" 
                            strokeDasharray="94.25 565.49" 
                            strokeLinecap="round"
                            initial={{ strokeDashoffset: 94.25, opacity: 0 }}
                            whileInView={{ strokeDashoffset: -471.24, opacity: 1 }}
                            viewport={{ once: true, margin: "-100px" }}
                            transition={{ 
                              strokeDashoffset: { duration: 0.7, delay: 2.2, ease: [0.34, 1.56, 0.64, 1] },
                      ...
                      <div className="space-y-2.5">
                        {/* Zakazani legend - appears with blue segment */}
                        <motion.div 
                        ...
                        {/* Završeni legend - appears with green segment */}
                        <motion.div 
                          className="flex items-center gap-2.5"
                          initial={{ opacity: 0, x: -10 }}
                          whileInView={{ opacity: 1, x: 0 }}
                        ...
                        >
                          <motion.div 
                            ...
                            whileInView={{ scale: 1 }}
                            viewport={{ once: true, margin: "-100px" }}
                            transition={{ duration: 0.3, delay: 1.9, ease: [0.34, 1.56, 0.64, 1] }}
                          />
                          <div className="flex-1 min-w-0">
                        ...
                        {/* Otkazani legend - appears with red segment */}
                        <motion.div 
                          className="flex items-center gap-2.5"
                          initial={{ opacity: 0, x: -10 }}
                          whileInView={{ opacity: 1, x: 0 }}
                        ...
                        >
                          <motion.div 
                            ...
                            whileInView={{ scale: 1 }}
                            viewport={{ once: true, margin: "-100px" }}
                            transition={{ duration: 0.3, delay: 2.6, ease: [0.34, 1.56, 0.64, 1] }}
                          />
                          <div className="flex-1 min-w-0">
