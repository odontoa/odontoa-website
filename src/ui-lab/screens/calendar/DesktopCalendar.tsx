...
// Follows the same structure as DesktopDashboard.tsx and DesktopPredracun.tsx
"use client";
      ...
      <div className="flex items-center gap-[12px] flex-shrink-0">
        ...
        <div className="flex items-center gap-[12px]">
          ...
          <div className="hidden sm:flex flex-col gap-[2px]">
            <div className="font-bold" style={{ fontSize: "16px", color: "var(--v2-text-heading)" }}>
              Dr Marko Marković
            </div>
...
export default function DesktopCalendar({ className }: { className?: string }) {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <main
          ...
          style={{ background: "var(--v2-bg)" }}
        >
          <CalendarNewDesignOgie size="wide" layout="desktop" />
        </main>
      </div>
    </div>
  );
