...
import {
  Search, Settings, Bell, Plus, X, Pencil, MoreHorizontal,
...
function UplataTopbar({ onAdd }: { onAdd: () => void }) {
  return (
    <header className="flex items-center justify-between flex-shrink-0 pl-[4px]" style={{ height: "var(--v2-topbar-h)" }}>
      <div className="flex flex-col justify-center py-[2px]" style={{ width: "340px" }}>
        <h1 className="font-semibold leading-[1.2]" style={{ fontSize: "22px", color: "var(--v2-text)" }}>Uplate</h1>
      </div>
      <div className="flex items-center gap-[12px] flex-shrink-0">
        <button onClick={onAdd} className="flex items-center gap-[6px] text-[13px] font-medium transition-opacity hover:opacity-90" style={{ padding: "9px 16px", borderRadius: "var(--v2-radius-pill)", background: "var(--v2-primary)", color: "var(--v2-primary-fg)" }}>
