      ...
      <main className="min-h-screen bg-background relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 pt-32 pb-20">
          ...
          <div className="prose max-w-none space-y-8">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">1. Uvod</h2>
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">2. Ko smo mi</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">3. Koje podatke prikupljamo</h2>
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">4. Svrha obrade</h2>
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">5. Pravna osnova obrade (GDPR)</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">6. Backup i bezbednost podataka</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">7. Deljenje podataka</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
                Podatke delimo sa:
              </p>
              <ul className="text-muted-foreground leading-relaxed space-y-2 list-disc list-inside mb-4">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">8. Vaša prava</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">9. Rok čuvanja podataka</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">10. Kolačići i analitika</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">11. Izmene ove politike</h2>
              <p className="text-muted-foreground leading-relaxed">
