      ...
      <main className="min-h-screen bg-background relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 pt-32 pb-20">
          ...
          <div className="prose max-w-none space-y-8">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">1. Opšte odredbe</h2>
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">2. Prava korišćenja i licenca</h2>
              ...
              <ul className="text-muted-foreground leading-relaxed space-y-2 list-disc list-inside mb-3">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">3. Kreiranje naloga i odgovornost</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">4. Pretplate, cene i obnavljanje</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">5. Zabrane korišćenja</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
                Zabranjeno je:
              </p>
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">6. Integracije i AI funkcionalnosti</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">7. Backup i sigurnost</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">8. Prekid korišćenja i suspenzija naloga</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">9. Ograničenje odgovornosti</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">10. Izmene uslova</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">11. Važeće pravo i rešavanje sporova</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
            ...
            >
              <h2 className="text-3xl font-semibold text-foreground mb-4">12. Kontakt</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
